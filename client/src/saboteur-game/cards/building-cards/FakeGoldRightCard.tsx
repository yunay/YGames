...
const CardSource = {
    ...
    beginDrag(props: any, monitor: any, component: any) {
        ...
        var cardId = getBuildingCardId(BuildingCards.FakeGoldRightCard)
...
export class FakeGoldRightCard extends BaseBuildingCard<any,any> {
    render() {
        const { connectDragSource, isDragging } = this.props;
        return connectDragSource(
            <span className="card-h fake-gold-right"></span>
        );
    }
}

...
const CardSource = {
    ...
    beginDrag(props: any, monitor: any, component: any) {
        ...
        var cardId = getBuildingCardId(BuildingCards.EndTunnelTripleTopCard)
...
export class EndTunnelTripleTopCard extends BaseBuildingCard<any, any> {
    render() {
        ...
        return connectDragSource(
            <span style={{
                ...
                cursor: 'move'
            }} className="card-h end-tunnel-triple-top"></span>
        );
    }
}

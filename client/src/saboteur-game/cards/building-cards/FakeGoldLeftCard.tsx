...
const CardSource = {
    ...
    beginDrag(props: any, monitor: any, component: any) {
        ...
        var cardId = getBuildingCardId(BuildingCards.FakeGoldLeftCard)
...
export class FakeGoldLeftCard extends BaseBuildingCard<any,any> {
    render() {
        const { connectDragSource, isDragging } = this.props;
        return connectDragSource(
            <span className="card-h fake-gold-left"></span>
        );
    }
}
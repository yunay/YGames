...
const CardSource = {
    ...
    beginDrag(props: any, monitor: any, component: any) {
        ...
        var cardId = getBuildingCardId(BuildingCards.VerticalTunnelCard);
...
export class VerticalTunnelCard extends BaseBuildingCard<any, any> {
    render() {
        ...
        return connectDragSource(
            <span style={{
                ...
                cursor: 'move'
            }} className="card-h vertical-tunnel"></span>
        );
    }
}

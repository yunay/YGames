...
const CardSource = {
    ...
    beginDrag(props: any, monitor: any, component: any) {
        ...
        var cardId = getBuildingCardId(BuildingCards.AngleLeftTopCard)
...
export class AngleLeftTopCard extends BaseBuildingCard<any, any> {
    render() {
        const { connectDragSource, isDragging } = this.props;
        return connectDragSource(
            <span style={{ opacity: isDragging ? 0.5 : 1, cursor: 'move' }}
                className="card-h angle-left-top"></span>)
    }
}

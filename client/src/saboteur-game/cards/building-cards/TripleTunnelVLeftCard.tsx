...
const CardSource = {
    ...
    beginDrag(props: any, monitor: any, component: any) {
        ...
        var cardId = getBuildingCardId(BuildingCards.TripleTunnelVLeftCard)
        return {
            id: cardId,
...
export class TripleTunnelVLeftCard extends React.Component<any, any> {
    render() {
        ...
        return connectDragSource(
            <span style={{
                ...
                cursor: 'move'
            }} className="card-h triple-tunnel-v-left"></span>
        );
    }
}

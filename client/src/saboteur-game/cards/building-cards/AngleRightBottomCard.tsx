...
const CardSource = {
    ...
    beginDrag(props: any, monitor: any, component: any) {
        ...
        var cardId = getBuildingCardId(BuildingCards.AngleRightBottomCard)
...
export class AngleRightBottomCard extends BaseBuildingCard<any, any> {
    render() {
        ...
        return connectDragSource(
            <span style={{
                ...
                cursor: 'move'
            }} className="card-h angle-right-bottom"></span>
        );
    }
}

...
const CardSource = {
    ...
    beginDrag(props: any, monitor: any, component: any) {
        ...
        var cardId = getBuildingCardId(BuildingCards.EndTunnelBottomCard)
...
export class EndTunnelBottomCard extends BaseBuildingCard<any, any> {
    render() {
        ...
        return connectDragSource(
            <span style={{
                ...
                cursor: 'move'
            }} className="card-h end-tunnel-bottom"></span>
        );
    }
}
